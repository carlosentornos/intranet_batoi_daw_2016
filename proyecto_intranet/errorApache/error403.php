...
<body>
            ...
            <div class="contenedor">
                <div class="error_apache">
                    ...
                    <br><div class="titulo_error">
                        <h2 class="negro">¡ACCESO PROHIBIDO!</h2>
                        <h3 class="negro">Motivo: no tiene permisos suficientes para ver el <span>contenido del sitio.</h3>
                    </div><br>

                    <div class="detalles">
                        <p><strong>Su solicitud no ha sido mostrada porque carece de permisos.</strong></p>
        ...
        <br><div id="pie" class="borderedondo">
