            ...
            <div class="contenedor">
                <form id="automodificado" action="php/testwebcam.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="nivel">
                        ...
                        <input class="botonnormal bloque reduccio" style="height:25px;" id="file" type="file" value="Subir foto">
                    </div>
                    
                    <div class="nivel">
                        <video hidden="true" id="video" width="250" height="160" autoplay></video><br class="oculto"><br class="oculto"><br class="oculto"><br class="oculto"><br class="oculto"><br class="oculto">
                        <button class="" hidden="true" id="snap">Snap Photo</button>
                        <canvas class="aliniadoderecha" style="border: 1px solid black;" hidden="true" id="canvas" width="220" height="160"></canvas>
                    </div>
