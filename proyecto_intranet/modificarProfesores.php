...
<html>
    <head>
        <meta charset="utf-8" />
        <title>formulario de modificacción de profesores</title>
        ...
        <script type="text/javascript" src="js/lib/modificarProfesores.js"></script>
    ...
    <body>
        ...
        <form id="form" action="php/gestionDirModAlum.php" method="post" enctype="multipart/form-data">
            ...
            <br><label> SELECCION PROFESOR:</label>
            <input type="text" id="buscarprofesor" name="buscaralumno"  autofocus/>
            <div id="box">
            ...
            <h4 class="centrado"> MODIFICACIÓN DE PROFESORES</h4><br>
            ...
            <div class="nivel">
                ...
                <input id="dni" type="text" name="dni" required placeholder="Empieza por 0, o X si es extranjero" pattern="[^X|0]+[0-9]+[A-Z]${10,10}"/>
            </div>
            ...
            <div class="nivel">
                ...
                <input id="domicilio" type="text" name="domicilio" required placeholder="Domicilio" pattern="{2,40}"/>
            </div>
 
            <div class="nivel">
                <label for="domicilioparticular"> Domicilio particular:</label>
                <input id="domicilioparticular" type="text" name="domicilioparticular" placeholder="Domicilio particular"  pattern="{0,25}"/>
            </div>
            
            <div class="nivel">
                <label for="provincia"> Provincia: *</label>
                <input id="provincia" type="text" name="provincia" required placeholder="Provincia"  pattern="{2,25}"/>
            </div>
